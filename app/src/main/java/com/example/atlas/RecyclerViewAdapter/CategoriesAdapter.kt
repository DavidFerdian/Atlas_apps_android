...
import com.example.atlas.DashboardFragment.HomeFragment
    ...
    inner class CategoriesHolder(itemView: View) :
        ...
        fun bind(
            ...
            itemView.setOnClickListener {
                homeFragment.setupCategoriesBottomSheet()
            }
            if (categoriesList.size >= 4) {
                homeFragment.binding.rvButtonLainnya.visibility = View.VISIBLE
            } else if (categoriesList.size <= 4) {
                homeFragment.binding.rvButtonLainnya.visibility = View.GONE
            }
        }
    }
